# [Project 1 - Standard, Trigonometry and Scientific Calculator](https://github.com/ssgalla/python/blob/master/basic-calculator.py)
...
# [Project 2 - Guess the number](https://github.com/ssgalla/python/blob/master/basic-guessthenumber.py)
...
# [Project 3 - Hangman](https://github.com/ssgalla/python/blob/master/basic_hangman.py)
...
# [Project 4 - Rock, Paper, Scissors](https://github.com/ssgalla/python/blob/master/basic_rockpaperscissors.py)
* A simple game of rock, paper, scissors.
* The computer randomly generates which one it is using the random module and a pre-compiled list. 
* Build a simple interface so user does not have to use the command line to play (currently in progress).

# [Project 5 - Roll the dice](https://github.com/ssgalla/python/blob/master/basic_rollthedice.py)
...
# [Project 6 - BS4 Web Scraping Monster Jobs](https://github.com/ssgalla/python/blob/master/basic-webscraper-monsterjobs.py)
...
# [Project 7 - Tweepy Python Twitter Bot API Calls Tutorial Document](https://github.com/ssgalla/python/blob/master/basic_twitter_tweepy_tutorial.py)
...
# [Project 8 - Tweepy Twitter API Bots](https://github.com/ssgalla/python/tree/master/tweepy_twitter_bot)
...
# [Project 9 - Pandas and NumPy code snippet booklet](https://github.com/ssgalla/python/tree/master/pandas_dataframe)
* A booklet with the most common functions from Pandas and NumPy
* Data Science and General Python Functions

# [Project 10 - Analyzing obesity in England - So who is getting fatter? and What about the future?](https://github.com/ssgalla/python/tree/master/analyzing_obesity_uk)
...
# [Project 11 - Analyzing confirmed COVID-19 cases in South Korea provinces from a slice of data found on dataset from Kaggle](https://github.com/ssgalla/python/tree/master/analyzing_covid_cases_south_korea/analyzing_case_data_city)
